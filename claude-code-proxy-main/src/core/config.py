...
class Config:
    def __init__(self):
        ...
        # LMP (Large Model Platform) settings
        self.api_provider = os.environ.get("API_PROVIDER", "openai")  # "openai" or "lmp"
        self.lmp_api_version = os.environ.get("LMP_API_VERSION", "")  # "" for V1, "V2" for V2 streaming format
    ...
    def is_lmp_mode(self) -> bool:
        """Check if LMP mode is enabled."""
        return self.api_provider == "lmp"

    def get_lmp_endpoint(self) -> str:
